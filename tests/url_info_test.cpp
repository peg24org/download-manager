...
// Ftp tests
TEST_F(URLInfoTest, should_get_default_ftp_port_number_from_url)
{
  constexpr static int DEFAULT_HTTP_PORT = 21;
  constexpr char URL[] = "ftp://www.example.com/file.dat";
...
TEST_F(URLInfoTest, should_get_non_default_ftp_port_from_url)
{
  constexpr static int NON_DEFAULT_HTTP_PORT = 1234;
  constexpr char URL[] = "ftp://www.example.com:1234/file.dat";
