...
class HttpsDownloader:public Downloader {
	...
	public:
        ...
        HttpsDownloader(node_struct* node_data, const addr_struct addr_data,off_t pos, off_t trd_length, int index):Downloader(node_data, addr_data, pos,trd_length, index)
			{
			}
